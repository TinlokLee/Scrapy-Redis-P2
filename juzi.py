        ...
        if cpy1:
            ...
            if tz:
                ...
                for tr in all_tr:
                    ...
                    tz_dict['tz_capital'] = all_td[2].get_text().strip().replace('\n', ',')
            ...
            if tm:
                for li in tm.find_all('li'):
                    ...
                    tm_dict['tm_m_intro'] = li.find('p', class_='mart10person-des').get_text().strip()
            ...
            if pdt:
                for li in pdt.find_all('li'):
                    ...
                    pdt_dict['pdt_type'] = li.find('span', class_='tagyellow').get_text().strip()
